...
class Struts_Options {
	...
	public function echo_form_html() { ?>
		<div id="struts-options" class="wrap">
			...
			<div style="padding: 10px 20px; background: #fff5c6; border: 1px solid #ffe56b; margin-top:20px;">
				<h2>Chalk Free Trial</h2>
				<p style="line-height: 22px; font-size: 14px;">You're using a free trial of Chalk. Theme options and many other features have been disabled. Please <a href="http://thethemefoundry.com/wordpress/chalk/">purchase Chalk PRO</a> to enable post formats, custom logo image, subscribe links, page templates, and many other features. You will also receive lifetime updates, dedicated support, documentation, and 25% off future theme purchases.</p>
				<p style="font-size: 14px"><a href="http://thethemefoundry.com/wordpress/chalk/">Purchase Chalk PRO &rarr;</a></p>
			</div>
			<div id="struts-options" class="wrap">
