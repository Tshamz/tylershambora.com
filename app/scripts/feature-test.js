...
(function($, FeatureTest, undefined) {
  ...
  var fullFeatureNameMap = {
    ...
    css2Dtransforms: 'CSS 2D Transforms',
    css3Dtransforms: 'CSS 3D Transforms',
